    ...
    <section id="about" className="about" aria-label="About Me">
      <div className="about-container">
        <div className="about-header">
          <span className="header-title-eyebrow">A Little About Me</span>
        </div>
        ...
        <div className="about-grid">
          ...
          <div className="about-content">
            <div className="about-narrative">
              <p>
                I enjoy building software, especially when the problem is
                complicated enough that figuring it out becomes half the fun.
              </p>
              <p>
                I&apos;m naturally curious and tend to go down rabbit holes
                whenever something catches my attention - sometimes technical,
                sometimes completely unrelated. I have a lot of interests and
                probably too many things I want to learn.
              </p>
              <p>
                Outside of engineering, I&apos;m usually somewhere between the
                gym, a YouTube rabbit hole, a good movie, a video game, or
                whatever has caught my interest that week.
              </p>
            </div>
          ...
          <aside className="about-sidebar" aria-label="Professional Details">
            <div className="about-sidebar-card">
              <div className="metadata-item">
                <div className="metadata-icon" aria-hidden="true">
                  <FaMapMarkerAlt />
                </div>
