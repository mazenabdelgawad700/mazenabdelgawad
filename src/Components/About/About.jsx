        ...
        <div className="row">
          <div className="about-main-text col-lg-6">
            ...
            <p className="colored-description">
              ...
              commitment to sharing great ideas that elevate the digital
              presence of my clients I believe that collaboration and creativity
              are the cornerstones of progress, and I am dedicated to bringing a
